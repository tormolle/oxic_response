# This script accompanies the vsearch bash script.txt located in the same folder.
# Creator: @torognes as part of the vsearch pipeline: https://github.com/torognes/vsearch/wiki/VSEARCH-pipeline.
